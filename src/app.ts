...
class ProjectState {
  // functions that will be run when sth chamges
...
class ProjectList {
  ...
  constructor(private type: "active" | "finished") {
    ...
    this.element = importentNode.firstElementChild as HTMLElement;
...
class ProjectInput {
  ...
  constructor() {
    ...
    this.element = importentNode.firstElementChild as HTMLFormElement;
  ...
  private gatherUserInput(): [string, string, number] | void {
    ...
    const peoplValidablee: Validatable = {
      value: +enteredPeople,
      required: true,
      min: 1,
      max: 5
